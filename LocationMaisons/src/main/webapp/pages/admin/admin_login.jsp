...
<head>
    ...
    <title>Connexion Admin - LocationMaisons</title>
        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    <figure>
                        <img src="${pageContext.request.contextPath}/images/admin.jpg" alt="admin login image">
                    </figure>
                    <a href="admin_register.jsp" class="signup-image-link">Créer un compte admin</a>
                </div>
                <div class="signin-form">
                    <h2 class="form-title">Connexion Admin</h2>
                    <form method="post" action="${pageContext.request.contextPath}/LoginAdminServlet">
